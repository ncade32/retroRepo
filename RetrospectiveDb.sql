...
INSERT INTO `admin` VALUES (1,'user','pass');
...
CREATE TABLE `feedback` (
  ...
  `teamNum` int(5) DEFAULT NULL,
  `projectName` varchar(45) DEFAULT NULL,
  `sprintNum` int(5) DEFAULT NULL,
  `wrongInfo` longtext,
  `wellInfo` longtext,
...
-- Dump completed on 2018-10-18 10:51:51
